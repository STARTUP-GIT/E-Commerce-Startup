  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full h-11 flex items-center justify-between px-3.5 rounded-xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] text-xs text-white focus:border-white/30 focus:outline-none transition-all cursor-pointer text-left font-medium select-none"
      >
