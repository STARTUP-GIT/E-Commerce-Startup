...
/** Feature flag type catalogue (spec-driven). */
...
/** Maps the human-facing type label to the Prisma enum value. */
export const featureTypeToEnum = (type: string): string =>
  type === "3D_PREVIEW" ? "THREE_D_PREVIEW" : type;
