...
import {
  TrendingUp, DollarSign, ShoppingBag, Users, Store, MapPin,
  AlertTriangle, Package, Clock, ArrowUpRight, Activity,
} from 'lucide-react';
  ...
  const stats = [
    {
      ...
      desc: 'Lifetime platform revenue',
      icon: DollarSign,
    ...
    },
    {
      ...
      value: dashboard?.totalCities ?? 0,
      desc: 'Operational districts/cities',
      icon: MapPin,
      iconColor: 'text-white/40',
      href: '/karnataka/districts',
    },
    {
      label: "Pending Approvals",
      value: dashboard?.pendingSellerApprovals ?? 0,
      desc: 'Sellers awaiting approval',
      icon: Clock,
      iconColor: 'text-white/40',
      href: '/sellers',
    },
    {
      ...
      value: dashboard?.pendingPackingRequests ?? 0,
      desc: 'Shop packing requests',
      icon: Package,
      iconColor: 'text-white/40',
      href: '/shops',
    },
    {
      ...
      desc: 'Unresolved product/shop reports',
      icon: AlertTriangle,
      iconColor: 'text-white/40',
      href: '/reports',
    },
