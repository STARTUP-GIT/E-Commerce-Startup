 ...
 * paths like /api/platform/profile, which Next.js rewrites server-side to
 * PLATFORM_BACKEND_API_URL/api/platform/profile. This means:
 *   ✅ Cookie domain matches — platform_session set on frontend origin is sent
...
const axiosInstance = axios.create({
  baseURL: isServer ? (process.env.PLATFORM_BACKEND_API_URL || '') : '',
